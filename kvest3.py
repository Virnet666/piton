...
if start1 == "start":
    ...
    if start=="хочу":
        ...
        if start2 == "согласен":
            ...
            if otgadivanyemasti==sagadannayamast:
                print("Нет! Думай дальше!")
                otgadivanyemasti=input('какую масть я загадал ')
            else:
                print("Молодец, Угадал")
                time.sleep(2)
                otgadivanyemasti=input("Так... Каую масть я загодал, ты-отгодал. а кокая карта ")
            if otgadivanyemasti!=sagadannayamast:
                print("Нет! Думай дальше!")
